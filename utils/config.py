...
class Config:
    ...
    def save(self):
        ...
        with open(join(self.saving_path, 'parameters.txt'), "w") as text_file:
            ...
            text_file.write('batch_limit = {:d}\n'.format(self.batch_limit))
            ...
            if self.weak_level is None:
                text_file.write('weak_level = full\n')
            else:
                text_file.write('weak_level = {:d}\n'.format(self.weak_level))
            text_file.write('al_itr = {:n}\n'.format(self.al_itr))
            text_file.write('al_initnum = {:n}\n'.format(self.al_initnum))
            text_file.write('al_num = {:n}\n'.format(self.al_num))
            text_file.write('acc_thr = {:n}\n'.format(self.acc_thr))
